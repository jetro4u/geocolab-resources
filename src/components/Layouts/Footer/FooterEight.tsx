            ...
            <div className="col-lg-2 col-md-6">
              <div className="single-footer-widget">
                ...
                <ul className="quick-links">
                  <li>
                    <Link href="/portfolio/details">Business Startup</Link>
                  </li>
                  <li>
                    <Link href="/portfolio/details">Finance Consulting</Link>
                  </li>
                  <li>
                    <Link href="/portfolio/details">Wealth Management</Link>
                  </li>
                  <li>
                    <Link href="/portfolio/details">Business Planning</Link>
                  </li>
                  <li>
                    <Link href="/portfolio/details">Data Management</Link>
                  </li>
                  <li>
