...
const DetailsContent2: React.FC = () => {
  return (
    <>
            ...
            <div className="col-xl-8 col-lg-7 col-md-12">
              <div className="blog-details-desc green-color">
                ...
                <p>
                  ...
                  aliquip ex ea <a href="#">commodo</a> consequat. Duis aute
                ...
                <ol>
                  ...
                  <li>
                    ...
                    phasellus ultrices fusce nibh justo, venenatis, amet. Lectus
                    quam.
                  </li>
                  <li>
                ...
                <div className="post-footer">
                  <div className="post-tags">
                    ...
                    <ul>
                      <li>
                        <Link href="/blog/tags">Web</Link>
                      </li>
                      <li>
                        <Link href="/blog/tags">Dev</Link>
                      </li>
                    </ul>
                  </div>
